...
import util from '~/common/requestUtil';
import "babel-polyfill";
Vue.prototype.interfaceApi = api;
Vue.prototype.requestUtil = util;
...
class VueTouch {
  ...
  // 点击结束
    ...
    if (_dis > 18 && _timeDis < 5000) {
      ...
      if ((_angle <= -175 && _angle > -180) || (_angle >= 175 && _angle <= 180))

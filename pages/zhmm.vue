      ...
      <g>
        ...
        <main>
            <div>
                ...
                <forgotPas1 v-if="isShow"></forgotPas1>
                <forgotPas2 v-else></forgotPas2>
            </div>
        </main>
        <footer>
            <foot></foot>
...
<script>
    import forgotPas1 from '~/components/login/forgotPas/forgotPas_1';
    import foot from '~/components/public/foot/foot1';
    import forgotPas2 from '~/components/login/forgotPas/forgotPas_2';
    export default {
        components: {
            forgotPas1,
            foot,

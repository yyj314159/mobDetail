  ...
  export default {
    ...
    async asyncData({app,params}){
      ...
      let contentObj = {
        ...
        console.log(params.id.split('_')[0])
        catid = params.id;
        let conId = params.id.split('_')[0];
        contentObj = requestUtil.validateData(await requestUtil.getData('/help/queryHelpDetail?fId='+ conId))

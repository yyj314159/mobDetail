...
<script>
    ...
    export default {
        ...
        async asyncData({params}){
            ...
            serverObj.keyword = params.param.split("_")[0];
            ...
            return {
                ...
                objData:{
                    module:'fuwu',
                    placeholder:'搜服务',
                    searchWord:serverObj.keyword
                }
            }
        },
        head(){
            return{
                'title':this.pageData.obj.keyword+'-找服务-族蚂商城zuma.com',
                meta:[
                    { name: 'description', content: '族蚂商城为您提供了餐饮、住宿、保洁、搬家、拖车、洗车等多种服务类型,支持微信、支付宝、银联的支付方式。品类丰富,安全快捷,满足不同用户的不同需求。' },
                    {name:'keywords',content:'上海生活服务,休闲娱乐,设备租赁,生活服务,保洁服务,婚庆,房屋装修,家政服务,'},
                ]
            }
        },
        mounted(){

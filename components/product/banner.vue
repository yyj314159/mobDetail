            ...
            <div  class="swiper-container zm_bannerWrap swiper-container-initialized swiper-container-vertical"
                ...
                <div class="swiper-wrapper">
                    <div class="zm_banner_wrap zm_banner_wrap1 swiper-slide"
                         style="background-image:url(/images/banner/shopping_01.png);background-repeat:no-repeat;background-position-x:left">
                        <div class="zm_banner_blank hide"></div>
                        <div class="banner_bg"
                             style="background-image:url( /images/banner/shopping_02.png);background-repeat:no-repeat;background-size:auto 200px;background-position-y:bottom">
                            <div class="banner_word">
                                <h1>发布您自己的商品</h1>
                                <p>在线销售商品，26万种交易流程供您选择！</p>
                                <div>点击这里</div>
                            </div>
                        </div>
                    ...
                    <div class="zm_banner_wrap zm_banner_wrap2 swiper-slide"
                         style="background-image:url(/images/banner/shopping2_01.png);background-repeat:no-repeat">
                        <div class="zm_banner_blank hide"></div>
                        <div class="banner_bg"
                             style="background-image:url(/images/banner/shopping2_02.png);background-repeat:no-repeat;background-size:auto 200px;background-position-y:bottom;background-position-x:right">
                            <div class="banner_word">
                                <h1>无限交易商机，尽在族蚂网！</h1>
                                <p>发布商品，把您的商城链接到公众号，锁定更多用户！</p>
                                <div>点击这里</div>
                            </div>
                        </div>
                        <div class="banner_blank hide"></div>
